...
//                Intent intent=new Intent(Login.this,CitiesList.class);
...
//                                updateUI(user);
    ...
    private void updateUI(FirebaseUser account){
        if(account !=  null){
            ...
            DatabaseReference myRef= FirebaseDatabase.getInstance().getReference("Admin").child(userId);
            myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists()) {
                        RecyclingIndustry recyclingIndustry = dataSnapshot.getValue(RecyclingIndustry.class);
                        Intent i = new Intent(Login.this, CitiesList.class);
