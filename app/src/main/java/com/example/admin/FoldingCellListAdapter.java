...
//            viewHolder.nameB=cell.findViewById(R.id.name);
        ...
        if(waste.recycled==true)
            viewHolder.recycledT.setText("Picked & Recycled");
        else if(waste.picked==true)
            viewHolder.recycledT.setText("Picked but not Recycled");
        else
            viewHolder.recycledT.setText("Neither Picked nor Recycled");
//        viewHolder.nameB.setText(waste.userId);
        ...
        if(waste.recycled==true)
            viewHolder.recycledB.setText("Picked & Recycled");
        else if(waste.picked==true)
            viewHolder.recycledB.setText("Picked but not Recycled");
        else
            viewHolder.recycledB.setText("Neither Picked nor Recycled");
//        }else {
